...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when entering this state machine via its Entry Node
    ...
    // OnStateMachineExit is called when exiting this state machine via its Exit Node
